...
@register
@serializable
class LMCocoDataset(COCODataSet):
    ...
    def __init__(self,
                 ...
                 empty_ratio=1.,
                 manual_length=None):
        super(LMCocoDataset, self).__init__(dataset_dir, image_dir, anno_path,
                                          data_fields, sample_num, load_crowd,
                                          allow_empty, empty_ratio)
