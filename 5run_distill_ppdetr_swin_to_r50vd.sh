...
log_dir=log_dir/swin_r50_kd_detr
...
nohup python3.7 -m paddle.distributed.launch --log_dir=${log_dir} --gpus 0,1,2,3,4,5,6,7 tools/train.py -c ${config} --slim_config ${tea_config} --eval >/dev/null 2>&1 &
