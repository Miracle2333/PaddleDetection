...
tea_config=configs/dino/ppdino_distill/distill_tea_ppdino_r50vd_to_r18vd_12e_kddetr.yml                                                                
                                                                                                                                                       
log_dir=log_dir/distill_stu_ppdino_r18vd_12e                                                                                                           
weights=output/distill_tea_ppdino_r50vd_to_r18vd_12e/0.pdparams                                                                                        
