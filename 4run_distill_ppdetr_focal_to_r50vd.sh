...
job_name=distill_stu_ppdino_focal_r50vd_12e
...
log_dir=log_dir/focal_r50_kd_detr
...
python python3.7 -m paddle.distributed.launch --log_dir=${log_dir} --gpus 0,1,2,3,4,5,6,7 tools/train.py -c ${config} --slim_config ${tea_config} --eval >/dev/null 2>&1 &
